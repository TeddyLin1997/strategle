      ...
      <div className="mb-8 md:mb-14 w-full flex">
        <div className="w-full md:w-3/5">
          ...
          <div className="mb-6 font-semibold">
            STRAG protocol allows users to mint <span className="text-primary text-xl" > STRAG tokens </span> using <span className="text-up text-xl">USDT</span> and stake the tokens to earn an AI-driven investment profits with <span className="text-primary text-xl">12%</span> APY. With flexible profit withdrawals and a focus on security and transparency, it offers a seamless crypto investment experience.
          </div>
